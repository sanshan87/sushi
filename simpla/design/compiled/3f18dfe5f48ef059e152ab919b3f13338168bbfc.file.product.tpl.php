...
>>>>>>> origin/skidki
  ...
  'nocache_hash' => '2096257a0d4fe4acee2-93099070',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_57a0d4fe768308_95896520',
  'variables' => 
  array (
    'product' => 0,
    'manager' => 0,
...
"/> 
		...
		<div class="checkbox">
			<input name=featured value="1" type="checkbox" id="featured_checkbox" <?php if ($_smarty_tpl->tpl_vars['product']->value->featured) {?>checked<?php }?>/> <label for="featured_checkbox">Популярный</label>
		</div>
	</div> 
